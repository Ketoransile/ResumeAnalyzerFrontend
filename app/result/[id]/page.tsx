    ...
    >
      {
        ...
        loading || (!isLoaded && !error && !isSignedIn) ? ( // Added !isSignedIn to ensure loading state is accurate before redirect
          ...
          <div className="text-center text-neutral-400 text-lg p-8">
            No analysis data found for this ID. This might be due to an invalid
            ID or a deleted analysis.
          </div>
        ) : (
          <Accordion
            type="multiple"
          ...
          >
            ...
            <AccordionContent className="pt-4">
              <div className="w-full flex items-center justify-between">
                <ScoreItem title="Total Score" value="90" />
                <ScoreItem title="Keyword Match Score" value="63" />
                <ScoreItem title="Experience Relevance Score" value="20" />
              </div>
            </AccordionContent>
          </AccordionItem> */}
            <AccordionItem
      ...
      "
                >
                  ...
                  <p className="text-center text-neutral-300 text-lg max-w-lg mb-4">
                    ...
                    profile with the job description, considering all key
                    analysis areas.
                  </p>
                  ...
                  <div className="mt-6 pt-4 border-t border-neutral-700/50 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <ScoreItem
                        ...
                        isLarge={false}
                      />
                      {/* Add more ScoreItem components if you have other relevant scores */}
                      {/* Example: <ScoreItem title="Soft Skills Match" value="75" isLarge={false} /> */}
                    </div>
                  </div>
                </div>

                {/* Call to Action for overall improvement / application */}
                {/* {analysisData.overall_fit_score < 90 && (
                <div className="mt-4 pt-4 border-t border-neutral-700/50 flex flex-wrap justify-center gap-3">
                  <button
                    className="
          ...
          "
                  ...
                  <button
                    className="
            bg-neutral-700 text-neutral-200 font-semibold py-3 px-6
          ...
          >
            ...
            <AccordionContent className="flex flex-col gap-4 ">
              ...
              <p>{`This score reflects the percentage of key terms and skills from the job description found directly in your resume.`}</p>
            </AccordionContent>
          </AccordionItem> */}
            <AccordionItem
              value="item-2"
    ...
    "
      ...
      "
          ...
          "
                    >
                      <p className="text-sm">
                        **Action Needed!** Your resume might be missing key
                        terms. Incorporate more direct keywords from the job
                        description.
                      </p>
                    </div>
                  )}
          ...
          "
                      >
                        <p className="text-sm">
                          Good match! You can further improve by subtly weaving
                          in more exact keywords from the job description.
                        </p>
                      </div>
                    )}
          ...
          "
                ...
                {/* {analysisData.keyword_match_score < 95 && (
            ...
            rounded-full shadow-lg hover:shadow-xl
            transition-all duration-300 transform
            hover:scale-105 hover:from-lime-700 hover:to-green-700
    ...
    "
      ...
      "
                  ...
                  <div className="relative w-32 h-32 flex items-center justify-center">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderTopColor: "transparent",
                        transform: `rotate(${
                          (analysisData.experience_relevance_score / 100) *
                            360 +
                          90
          ...
          "
                    >
                      <p className="text-sm">
                        Consider tailoring your experience descriptions to
                        better highlight relevant achievements for this role.
                      </p>
                    </div>
                  )}
          ...
          "
                ...
                {/* {analysisData.experience_relevance_score < 85 && (
                <div className="mt-4 pt-4 border-t border-neutral-700/50 flex flex-wrap gap-3">
                  <button
                    className="
            ...
            rounded-full shadow-lg hover:shadow-xl
            transition-all duration-300 transform
            hover:scale-105 hover:from-cyan-700 hover:to-teal-700
          ...
          >
            ...
            <AccordionContent className="flex flex-col gap-2">
              {analysisData.top_matching_skills.length > 0 ? (
                <ul className="list-disc flex flex-wrap gap-2  pl-5">
    ...
    "
        ...
        "
          ...
          >
            ...
            <AccordionContent className="flex flex-col gap-2">
              {analysisData.key_qualification_gaps.length > 0 ? (
                <ul className="list-disc pl-5 bg-neutral-800 p-3 rounded-md ">
                  {analysisData.key_qualification_gaps.map((gap, index) => (
                    <li
                      key={index}
                      // className=" flex items-center gap-2  mb-2 border border-neutral-600 p-4 rounded-xl"
                      className=" flex items-center gap-4  mb-2  p-4 rounded-xl"
                    >
                      <span
                        role="img"
                        aria-label="warning"
    ...
    "
        ...
        "
                  >
                    ...
                    <p className="text-neutral-400 text-center max-w-md">
                      Your current qualifications align well with market
                      demands. Keep up the great work!
                    </p>
                  </div>
                )}
              </AccordionContent>
          ...
          >
            ...
            <AccordionContent className="flex flex-col gap-2">
              {analysisData.actionable_enhancements.length > 0 ? (
                <ul className="list-disc pl-5 bg-neutral-800 p-4 rounded-md border border-neutral-700">
                  {analysisData.actionable_enhancements.map(
                    (enhancement, index) => (
                      <li
                        key={index}
                      ...
                      >
                        <span role="img" aria-label="enhance">
                          🛠️
                        </span>
                        {enhancement}
                      </li>
                ...
                <p className="text-green-400 flex items-center gap-2">
                  ...
                  No specific enhancements suggested — great job!
                </p>
              )}
            </AccordionContent>
          </AccordionItem> */}
  ...
  "
    ...
    "
        ...
        "
                  >
                    <p className="text-neutral-300 mb-3 font-semibold text-lg">
                      Consider these steps to boost your profile and
                      application:
                    </p>
                    <ul className="space-y-3">
                      {analysisData.actionable_enhancements.map(
    ...
    "
        ...
        "
                  >
                    ...
                    <p className="text-neutral-400 text-center max-w-md">
                      Please provide more details or a job description to
